...
module.exports = {
    ...
    mailDetails: (email, name) => {                                           //^Mail de bienvenida para el cliente
        ...
        return {
            ...
            <h1 style="color: #007BFF; margin-bottom: 10px;">¡Bienvenido a MEGAStore!</h1>
            <p style="font-size: 16px; color: #333;">¡Hola ${name}!</p>
            <p style="font-size: 16px; color: #333;">Estamos emocionados de darte la bienvenida a nuestra tienda virtual. En MEGAStore, no solo encuentras accesorios para celulares, sino que también descubrirás un mundo de innovación y estilo para complementar tu dispositivo.</p>
            ...
            <p style="font-size: 16px; color: #333;">Gracias por unirte a la familia MEGAStore. ¡Esperamos que tu experiencia de compra sea extraordinaria!</p>
            <p style="font-size: 16px; color: #333;">Atentamente, El equipo de MEGAStore</p>
        </div>
